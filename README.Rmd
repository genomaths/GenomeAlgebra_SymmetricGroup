...
himself/herself the computations discussed in the text. A Wolfram Player is
can be used to interact with a Mathematica notebook, in the same way that, for
example, Adobe Reader is required to open a PDF. The installation of Wolfram
...
notebook: _IntroductionToZ5GeneticCodeVectorSpace.nb_.  This CDF would be useful
...
illustrated in the CDF:   _Genetic-Code-Scales_of_Amino-Acids.nb_. This is a
Mathematica notebook containing an interactive graphical user interface tool to
